...
class PnPLCommandAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PnPLCommandViewHolder {
    ...
    override fun onBindViewHolder(holder: PnPLCommandViewHolder, position: Int) {
