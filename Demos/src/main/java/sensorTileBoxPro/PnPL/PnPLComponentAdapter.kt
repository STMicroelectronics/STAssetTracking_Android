...
import com.st.demos.databinding.PnplComponentElementBinding
import com.st.demos.polaris.ExtConfig.nameResource
...
class PnPLComponentAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PnPlComponentViewHolder {
    ...
    override fun onBindViewHolder(holder: PnPlComponentViewHolder, position: Int) {
        ...
        if(currentItem.isCollapsed){
            ...
            holder.componentExpandImage.setBackgroundResource(R.drawable.ic_expand_view)
        }else{
            ...
            holder.componentExpandImage.setBackgroundResource(R.drawable.ic_collaps_view)
        }
