package com.st.nfcSmarTag.v2.provisioning
...
class Nfc2ProvisioningDevice : AppCompatActivity() {

    private lateinit var nfcTagHolder: NfcTag2ViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nfc2_provisioning_device)
        ...
        if (!(pm.hasSystemFeature(PackageManager.FEATURE_NFC))) {
            ...
            setContentView(R.layout.activity_nfc2_provisioning_device)
            mainView = findViewById(R.id.nfc2_provisioning_root_view)

            tvInfoNFCid = findViewById(R.id.tv_nfc2_id)

            ivBoard = findViewById(R.id.board_nfc2_image)

            setBoardImageResized(ivBoard)

            errorToast = Toast(this)

            nfcTagHolder = NfcTag2ViewModel.create(this)
            ...
            nameEditText = findViewById(R.id.register_nfc2_device_name)
            mRegisterButton = findViewById(R.id.btn_NFC2_registration)
            ...
            yourTextWatcher = object : TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                    ...
                    mRegisterButton.isEnabled =
                        validDeviceName && nfcTagHolder.nfcTagId.value?.isNotEmpty() ?: false
                }
            }
            nameEditText.addTextChangedListener(yourTextWatcher)

            // Registration Button
            findViewById<Button>(R.id.btn_NFC2_registration).setOnClickListener {
    ...
    private fun setBoardImageResized(ivBoard: ImageView) {
        Glide
            ...
            .load(R.drawable.board_smartag2)
            .fitCenter()
            .into(ivBoard)
    }

    private fun provisioningDevice(nfcProvisioningDevice: Nfc2ProvisioningDevice, activityResultRegistry: ActivityResultRegistry) {
